                    ...
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <form id="ratingsForm" data-sb-form-api-token="API_TOKEN">
                          <div class="form-floating mb-3">
                                  <input class="form-control mb-3" id="name" type="text" placeholder="Enter retaurant name" data-sb-validations="required" />
                          ...
                          <div class="d-grid"><button class="btn btn-primary btn-xl" id="submitButton" type="submit">Submit your rating</button></div>
